...
let isVideoToolsPageMode = String(pageParams.get('view') || '').trim().toLowerCase() === 'video-tools';
...
const accessScopeModule = typeof window.createMainAccessScopeModule === 'function'
  ? window.createMainAccessScopeModule()
  : null;
...
function setVideoToolsPageModeActive(active) {
...
function openVideoToolsInPlace(assetId, startAtSeconds = 0, nextUrl = null, backPanels = '') {
  ...
  if (!id) return false;
  setVideoToolsPageModeActive(true);
  applyVideoToolsPanelState(backPanels);
  if (nextUrl) window.history.pushState({ view: 'video-tools', assetId: id }, '', nextUrl.toString());
  getWorkflow()
...
function showShortcutToast(message, options) {
  return shellModule.showShortcutToast(message, options);
}
...
let i18n = {
  en: {
    ...
    version_preview_loaded: '{name} preview loaded',
    default_version: 'Default',
    make_default_version: 'Make default',
    download_attachment: 'Download',
    edit_attachment_name: 'Edit name',
    ...
    version_file_required: 'Please select a file.',
    ...
    asset_title_required: 'Please enter an asset name.',
    ...
    subtitles: 'Subtitles',
    subtitle_lang: 'Lang',
    subtitle_lang_turkish: 'Turkish',
    subtitle_lang_english: 'English',
    subtitle_upload_lang_confirm: 'You are about to upload {lang} subtitle ({code}). To change it, enter the required abbreviation in the Lang field.',
    ...
    subtitle_translate_tr: 'Translate to Turkish',
    subtitle_translate_started: 'Subtitle translation started. Please wait...',
    subtitle_translate_success: 'Subtitle translated.',
    subtitle_translate_failed: 'Subtitle translation failed.',
    subtitle_translate_source_required: 'Select or load a source subtitle first.',
    ...
    video_ocr_range_mode: 'TC selection',
    video_ocr_range_full: 'Do not select TC',
    video_ocr_range_manual: 'Select TC',
    video_ocr_range_in: 'In TC',
    video_ocr_range_out: 'Out TC',
    video_ocr_range_invalid: 'Invalid timecode range. Example: 00:00:10:00 - 00:00:20:00',
    video_ocr_range_order: 'OUT TC must be greater than IN TC.',
    ...
    video_ocr_list: 'OCR results',
    video_ocr_no_items: 'No OCR results yet.',
    video_ocr_active: 'Active',
    video_ocr_use: 'Set active',
    video_ocr_remove: 'Delete',
    video_ocr_remove_confirm: 'Delete this OCR result?',
    ocr_lines_short: 'lines',
  ...
  tr: {
    ...
    metadata_save_failed: 'Metadata kaydetme başarısız.',
    metadata_edit_locked: 'Metadata düzenleme yetkiniz yok.',
    dublin_core: 'Dublin Core Metadata',
    dc_title: 'DC Başlık',
    dc_creator: 'DC Oluşturan',
    dc_subject: 'DC Konu',
    dc_description: 'DC Açıklama',
    dc_publisher: 'DC Yayıncı',
    dc_contributor: 'DC Katkıda Bulunan',
    dc_date: 'DC Tarih',
    dc_type: 'DC Tür',
    dc_format: 'DC Biçim',
    dc_identifier: 'DC Tanımlayıcı',
    dc_source: 'DC Kaynak',
    dc_language: 'DC Dil',
    dc_relation: 'DC İlişki',
    ...
    versions_empty: 'Henüz versiyon yok.',
    attachments: 'Ek dosyalar',
    attachments_empty: 'Henüz ek dosya yok.',
    version_preview_loaded: '{name} önizlemesi yüklendi',
    default_version: 'Varsayılan',
    make_default_version: 'Varsayılan yap',
    download_attachment: 'İndir',
    edit_attachment_name: 'Adını düzenle',
    ...
    version_file_required: 'Lütfen bir dosya seçin.',
    version_added: 'Versiyon eklendi',
    attachment_added: 'Dosya eklendi',
    file_role: 'Dosya rolü',
    new_version: 'Yeni versiyon',
    attachment_file: 'Ek dosya',
    ...
    asset_title_required: 'Lütfen varlık adını girin.',
    ...
    subtitles: 'Altyazı',
    subtitle_lang: 'Dil',
    subtitle_lang_turkish: 'Türkçe',
    subtitle_lang_english: 'İngilizce',
    subtitle_upload_lang_confirm: '{lang} altyazı yüklemek üzeresiniz ({code}). Dili değiştirmek için Dil alanına gerekli kısaltmayı girin.',
    ...
    subtitle_translate_tr: 'Türkçeye Çevir',
    subtitle_translate_started: 'Altyazı çevirisi başladı. Lütfen bekleyin...',
    subtitle_translate_success: 'Altyazı çevrildi.',
    subtitle_translate_failed: 'Altyazı çevirisi başarısız.',
    subtitle_translate_source_required: 'Önce kaynak altyazıyı seçin veya yükleyin.',
    ...
    video_ocr_range_mode: 'TC seçimi',
    video_ocr_range_full: 'TC seçme',
    video_ocr_range_manual: 'TC seç',
    video_ocr_range_in: 'In TC',
    video_ocr_range_out: 'Out TC',
    video_ocr_range_invalid: 'Geçersiz zaman aralığı. Örnek: 00:00:10:00 - 00:00:20:00',
    video_ocr_range_order: 'OUT TC, IN TC değerinden büyük olmalıdır.',
    ...
    video_ocr_list: 'OCR sonuçları',
    video_ocr_no_items: 'Henüz OCR sonucu yok.',
    video_ocr_active: 'Aktif',
    video_ocr_use: 'Aktif yap',
    video_ocr_remove: 'Sil',
    video_ocr_remove_confirm: 'Bu OCR sonucu silinsin mi?',
    ocr_lines_short: 'satır',
...
async function loadCurrentUser() {
  ...
  try {
    ...
    accessScopeModule?.applyAssetTypeScope?.({
      ...
      uploadAllowedAssetTypes: Array.isArray(me.uploadAllowedAssetTypes) ? me.uploadAllowedAssetTypes : null,
      ingestForm,
      assetTypeFilters
    });
  } catch (_error) {
