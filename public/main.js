...
const detailModule = window.createMainDetailModule({
  t,
  tf,
  api,
  deleteApi,
...
function getVersionSectionAccess(asset) {
  return detailModule.getVersionSectionAccess(asset);
}

function renderVersionRow(asset, version, access, interactive) {
  return detailModule.renderVersionRow(asset, version, access, interactive);
}

async function refreshAssetDetail(assetId, workflow) {
  return detailModule.refreshAssetDetail(assetId, workflow);
}

function detailMarkup(asset, workflow) {
  return detailModule.detailMarkup(asset, workflow);
}
