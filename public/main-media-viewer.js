...
function mediaViewer(asset, options = {}) {
  ...
  if (isAudio(asset)) {
        ...
        <div class="viewer-shell audio-tools-viewer-shell">
          <div class="viewer-core">
            ...
            <div class="video-top-layout audio-tools-top-layout">
              <div class="video-main-col">
                <div class="audio-subtitle-stage" data-audio-subtitle-stage="1" data-viewer-loading="audio">
              ...
              <div class="collapsible-body">
                ...
                <div class="subtitle-tools-layout">
                  ...
                  <div class="tool-actions">
                    ...
                    <button type="button" id="subtitleTranslateBtn">${t('subtitle_translate_tr')}</button>
                    <button type="button" id="subtitleRenameBtn">${t('subtitle_save_name')}</button>
                    <div class="tool-file-wrap"><label class="localized-file-input subtitle-localized-file-input">
                    <input id="subtitleFileInput" type="file" accept=".vtt,.srt,text/vtt,application/x-subrip" />
                    <span class="localized-file-input-button">${escapeHtml(t('choose_file'))}</span>
                    <span class="localized-file-input-name" data-subtitle-file-name>${escapeHtml(t('no_file_chosen'))}</span>
                  </label><button type="button" id="subtitleUploadBtn">${t('subtitle_upload')}</button></div>
                  </div>
                </div>
              </div>
            </div>
    ...
    return `
      <div class="audio-detail-viewer" data-audio-viewer="1" data-viewer-loading="audio">
