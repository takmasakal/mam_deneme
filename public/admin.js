...
let i18n = {
  en: {
    ...
    health_job_status_cancelled: 'Cancelled',
    health_job_type: 'Job type',
    health_job_type_short: 'Type',
    health_job_status: 'Status',
    health_job_filter_all_types: 'All job types',
    health_job_filter_all_statuses: 'All statuses',
    health_job_filter_period: 'Time period',
    health_job_filter_empty: 'No media jobs match the selected filters.',
    health_job_refresh: 'Refresh media jobs',
    health_job_refresh_failed: 'Media jobs could not be refreshed',
    health_job_phase: 'Current phase',
    health_job_started: 'Started',
    health_job_cancel: 'Cancel',
    health_job_cancel_confirm: 'Cancel this running media job?',
    health_job_cancel_failed: 'Media job could not be cancelled',
    health_job_phase_queued: 'Waiting in queue',
    health_job_phase_preparing: 'Preparing',
    health_job_phase_preparing_audio: 'Preparing audio',
    health_job_phase_model_loading: 'Loading model',
    health_job_phase_transcribing: 'Transcribing',
    health_job_phase_aligning: 'Aligning words',
    health_job_phase_writing_subtitles: 'Writing subtitles',
    health_job_phase_sampling_frames: 'Sampling frames',
    health_job_phase_model_ready: 'OCR model ready',
    health_job_phase_recognizing_frames: 'Recognizing frames',
    health_job_phase_saving: 'Saving result',
    health_job_phase_loading_asset: 'Loading asset',
    health_job_phase_summarizing_document: 'Summarizing document',
    health_job_phase_generating_metadata: 'Generating metadata',
    health_job_phase_saving_metadata: 'Saving metadata',
    health_job_phase_completed: 'Completed',
    health_job_phase_failed: 'Failed',
    health_job_phase_cancelled: 'Cancelled',
    health_job_phase_interrupted: 'Interrupted by restart',
    ...
    user_permissions_empty: 'No user or group found.',
  ...
  tr: {
    ...
    health_job_status_cancelled: 'İptal edildi',
    health_job_type: 'İş türü',
    health_job_type_short: 'Tür',
    health_job_status: 'Durum',
    health_job_filter_all_types: 'Tüm iş türleri',
    health_job_filter_all_statuses: 'Tüm durumlar',
    health_job_filter_period: 'Zaman aralığı',
    health_job_filter_empty: 'Seçilen filtrelerle eşleşen medya işi yok.',
    health_job_refresh: 'Medya işlerini yenile',
    health_job_refresh_failed: 'Medya işleri yenilenemedi',
    health_job_phase: 'Güncel aşama',
    health_job_started: 'Başladı',
    health_job_cancel: 'İptal',
    health_job_cancel_confirm: 'Çalışan medya işi iptal edilsin mi?',
    health_job_cancel_failed: 'Medya işi iptal edilemedi',
    health_job_phase_queued: 'Kuyrukta bekliyor',
    health_job_phase_preparing: 'Hazırlanıyor',
    health_job_phase_preparing_audio: 'Ses hazırlanıyor',
    health_job_phase_model_loading: 'Model yükleniyor',
    health_job_phase_transcribing: 'Altyazı çıkarılıyor',
    health_job_phase_aligning: 'Kelimeler hizalanıyor',
    health_job_phase_writing_subtitles: 'Altyazı yazılıyor',
    health_job_phase_sampling_frames: 'Kareler alınıyor',
    health_job_phase_model_ready: 'OCR modeli hazır',
    health_job_phase_recognizing_frames: 'Kareler okunuyor',
    health_job_phase_saving: 'Sonuç kaydediliyor',
    health_job_phase_loading_asset: 'Varlık yükleniyor',
    health_job_phase_summarizing_document: 'Doküman özetleniyor',
    health_job_phase_generating_metadata: 'Metadata üretiliyor',
    health_job_phase_saving_metadata: 'Metadata kaydediliyor',
    health_job_phase_completed: 'Tamamlandı',
    health_job_phase_failed: 'Hatalı',
    health_job_phase_cancelled: 'İptal edildi',
    health_job_phase_interrupted: 'Yeniden başlatma nedeniyle kesildi',
    ...
    user_permissions_empty: 'Kullanıcı veya grup bulunamadı.',
...
const adminSystemHealthModule = window.createAdminSystemHealthModule({
  api,
  t,
  escapeHtml,
  ...
  elements: {
    ffmpegHealth: ffmpegHealthEl,
    systemHealthRows,
    systemJobStatus: systemJobStatusEl,
...
async function refreshTrackingAndHealth(options = {}) {
  return adminSystemHealthModule.refresh(options);
}
