...
const { createAssetVersionService } = require('./services/assetVersionService');
const { createAssetMapperService } = require('./services/assetMapperService');
...
const DEFAULT_BACKUP_DIR = process.env.MAM_BACKUP_DIR || '/home/belge/depo/netapp/belgelik-restic/db-backups';
const DEFAULT_RESTIC_REPOSITORY = process.env.RESTIC_REPOSITORY || '/home/belge/depo/netapp/belgelik-restic/restic-repo';
...
const mediaToolService = createMediaToolService({
  fs,
  spawn,
  trackMediaJobProcess,
  isMediaJobCancelled
...
const assetVersionService = createAssetVersionService({
  pool,
  fs,
  path,
  sanitizeFileName,
...
const assetMapperService = createAssetMapperService({
  resolveStoredUrl,
